...
OUTPUT_DIR = "/data/users/dyx/Myproject/FetalPlaneClass/output/conv2/large/test"
...
CHECKPOINT_PATH="/data/users/dyx/Myproject/FetalPlaneClass/output/conv2/large/f1_92.53053-epoch_4.pth"
NUM_CLASSES = 22
...
def main():
    ...
    model = getattr(convnextv2, MODEL)(
        pretrained=False,
